...
export default function SpeechBubble({ headRef }) {
  ...
  useEffect(() => {
    ...
    function track() {
      ...
      const ARROW_FROM_BOTTOM = 12 // px — arrow sits 12px from bubble bottom edge
      const MOUTH_FROM_TOP    = 0.64 // fraction — mouth is ~64% down the canvas
      const mouthY  = rect.top + rect.height * MOUTH_FROM_TOP
      const right   = window.innerWidth - (rect.right - rect.width * 0.72)
      const bottom  = window.innerHeight - mouthY - ARROW_FROM_BOTTOM
