...
export default function HomeContent() {
  ...
  return (
    <>
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          HERO — edit freely below this line
      ───────────────────────────────────────────────────────────────────── */}
      <Section
      ...
      >
        ...
        <div className="relative z-[2] flex-1 max-w-[780px] max-[900px]:pt-32 max-[900px]:w-full">
          <div className={`hero-tag font-mono text-[12px] text-mint tracking-[0.15em] uppercase mb-7 flex items-center gap-[10px] opacity-0 ${introComplete ? 'animate-fade-up-1' : ''}`}>
            Always cooking something
          </div>
          <h1 className={`text-[clamp(40px,7vw,86px)] font-bold leading-[1.05] tracking-[-0.03em] opacity-0 ${introComplete ? 'animate-fade-up-2' : ''}`}>
            Full Stack<br />
            <span className="text-violet">Developer</span><br />
            <span className="text-muted">&amp; UI Craftsman</span>
          </h1>
          <p className={`font-mono text-[15px] text-muted leading-[1.7] mt-7 max-w-[500px] opacity-0 ${introComplete ? 'animate-fade-up-3' : ''}`}>
            I build fast, beautiful interfaces and robust backends.<br />
            React, Vue, WordPress, Drupal, Webflow and whatever it takes.
          </p>
          <div className={`flex max-[640px]:flex-col gap-4 mt-11 opacity-0 ${introComplete ? 'animate-fade-up-4' : ''}`}>
            <Button href="#projects" variant="primary">View How I Work</Button>
            <Button href="#contact" variant="secondary">Get In Touch</Button>
          </div>

          <div className={`hidden max-[900px]:flex flex-wrap gap-2 mt-10 opacity-0 ${introComplete ? 'animate-fade-up-5' : ''}`}>
        ...
        <div className={`relative z-[2] flex flex-col gap-3 opacity-0 max-[900px]:hidden ml-auto ${introComplete ? 'animate-fade-left' : ''}`}>
          {['React','Vue.js','WordPress','Drupal','Webflow','Node.js','PHP'].map((t, i) => (
        ...
        <div className={`absolute bottom-10 left-[60px] max-[640px]:left-6 flex items-center gap-3 opacity-0 max-[900px]:hidden ${introComplete ? 'animate-fade-up-5' : ''}`}>
