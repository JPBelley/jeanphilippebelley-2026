...
export default function HomeContent() {
  ...
  return (
    <>
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          HERO v2 — editorial big-type layout
      ───────────────────────────────────────────────────────────────────── */}
      <section
        id="home"
        style={{
      ...
      >
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse 80% 60% at 50% 60%, rgba(124,92,255,0.07) 0%, transparent 70%)',
        }} />

        {/* ── Anton — ultra bold condensed display ──────────────── */}
        <style>{`@import url('https://fonts.googleapis.com/css2?family=Anton&display=swap');`}</style>

        {/* ── Full-bleed SVG — each word stretched edge to edge ──── */}
        <div style={{
          width:     '100%',
          lineHeight: 0,
          opacity:   introComplete ? 1 : 0,
        ...
        <div style={{
          ...
          padding:        'clamp(32px, 5vh, 64px) clamp(24px, 6vw, 96px) 0',
          gap:            '32px',
          flexWrap:       'wrap',
          opacity:        introComplete ? 1 : 0,
          ...
          <p style={{
            ...
            React · Vue · WordPress · Drupal · Webflow · Node.js
          </p>
        ...
        <div style={{
          ...
          <div style={{ width: 1, height: 48, background: 'linear-gradient(to bottom, transparent, var(--color-ui))' }} />
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--color-muted)', letterSpacing: '0.1em', writingMode: 'vertical-lr' }}>Scroll</span>
        </div>
      </section>

      {/* ─────────────────────────────────────────────────────────────────────
          HERO v1 — commented out
      ───────────────────────────────────────────────────────────────────── */}
      {/*
      <Section
      ...
      >
        ...
        <div className="relative z-[2] flex-1 max-w-[780px] max-[900px]:pt-32 max-[900px]:w-full">
          <div className="hero-tag font-mono text-[12px] text-mint tracking-[0.15em] uppercase mb-7 flex items-center gap-[10px]">Always cooking something</div>
          <h1 className="text-[clamp(40px,7vw,86px)] font-bold leading-[1.05] tracking-[-0.03em]">
            Full Stack<br /><span className="text-violet">Developer</span><br /><span className="text-muted">&amp; UI Craftsman</span>
          </h1>
          <p className="font-mono text-[15px] text-muted leading-[1.7] mt-7 max-w-[500px]">
            I build fast, beautiful interfaces and robust backends.<br />React, Vue, WordPress, Drupal, Webflow and whatever it takes.
          </p>
