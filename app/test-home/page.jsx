    ...
    <>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div className="font-mono text-[11px] text-violet tracking-[0.2em] uppercase mb-6 flex items-center gap-3">
            <span className="w-[6px] h-[6px] bg-violet inline-block animate-status-pulse" />
            Available for work
          </div>
          <h1 className="text-[clamp(48px,7vw,96px)] font-bold tracking-[-0.03em] leading-[1.0] mb-8">
            Jean-Philippe<br /><span className="text-violet">Belley</span>
          </h1>
          <p className="font-mono text-[clamp(14px,1.4vw,17px)] text-muted leading-[1.7] max-w-[520px] mb-10">
            Full stack developer with a frontend focus. I build fast, precise, and maintainable interfaces.
          </p>
          <div className="flex items-center gap-4 flex-wrap">
            <Link href="#about" className="font-mono text-[12px] tracking-[0.1em] uppercase px-6 py-3 border border-violet text-violet hover:bg-violet hover:text-black transition-colors duration-200 no-underline">
              Learn more
            </Link>
            <Link href="/contact" className="font-mono text-[12px] tracking-[0.1em] uppercase px-6 py-3 border border-ui text-muted hover:border-foreground hover:text-foreground transition-colors duration-200 no-underline">
              Get in touch
            </Link>
          </div>
        </div>
